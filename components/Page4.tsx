...
export default function Page4({ wishlist }: Page4Props) {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-8 snap-center relative overflow-hidden">

        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 text-center z-10">
            The <span className="text-red-400">"Maybe Later"</span> List
        </h2>
        ...
        <div className="mt-16 bg-gradient-to-r from-red-900/40 to-orange-900/40 border border-red-500/30 p-6 rounded-2xl flex items-center gap-4 max-w-2xl w-full z-10 backdrop-blur-sm">
            ...
            <div>
            <h4 className="text-red-400 font-bold uppercase tracking-widest text-sm">Next Wallet Sacrifice</h4>
