...
export default function Page6({ data }: Page6Props) {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-8 snap-center">
            <h2 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#1A9FFF] to-[#4EB5FF] mb-10 text-center tracking-tight filter drop-shadow-[0_0_20px_rgba(26,159,255,0.4)]">
                Your 2026 Wrapped
            </h2>
            ...
            <div className="bg-slate-900/80 p-6 md:p-8 rounded-3xl border border-slate-700 shadow-2xl max-w-4xl w-full relative overflow-hidden backdrop-blur-md">
                <div className="absolute -top-20 -right-20 w-48 h-48 bg-[#1A9FFF]/20 rounded-full blur-[60px] pointer-events-none"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative z-10">
                    ...
                    {top1 && (
                        <div className="md:col-span-1 bg-slate-950/60 rounded-2xl border border-slate-800 p-6 flex flex-col items-center justify-center text-center relative overflow-hidden group">
                            ...
                            <p className="text-[#1A9FFF] font-black text-2xl z-10 relative mt-auto">
                                {Math.round(top1.playtime_forever / 60).toLocaleString()} <span className="text-sm font-medium text-slate-400">HRS</span>
                            </p>
                            
                            <div className="absolute inset-0 bg-[#1A9FFF]/5 blur-2xl z-0 transition-all group-hover:bg-[#4EB5FF]/10"></div>
                        </div>
                    )}
